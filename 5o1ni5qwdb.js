...
var theme = '62-aldi';
var template = 'surbox';
var brand_country = 'Deutschland';
var dayNames = Array("Sonntag", "Montag", "Dienstag", "Mittwoch", "Donnerstag", "Freitag", "Samstag");
var monthNames = new Array("Januar", "Februar", "März", "April", "Mai", "Juni", "Juli", "August", "September", "Oktober", "November", "Dezember");
var img_regalo = "38gz1p8w27.png";
var minutos_y = "Minuten und ";
var segundos = "Sekunden";
var url_f = "";
var modalOptions = {
...
if (jQuery(document).ready(function () {
  ...
  1 <= jQuery("#timerr").length && (n = 89, o = setInterval(function () {
    t = parseInt(n / 60, 10), e = (e = parseInt(n % 60, 10)) < 10 ? "0" + e : e, $("#timerr").text(t + " " + minutos_y + e + " " + segundos), --n < 0 && clearInterval(o)
                                                             ...
                                                             , 1e3));
  var r = new Date, a = i(r.getHours()) + ":" + i(r.getMinutes()), u = i(r.getMonth() + 1);
  ...
  if (0 < jQuery("#questions_all").length) {
    var e = 100, n = parseInt(jQuery("#questions_all").data("total"));
...
var deactivationTimerHandler, reactivationTimerHandler, animationHandler, particles = [], angleConfetti = 0,
                                                                                       tiltAngle = 0, confettiActive = !1, confettiIniciated = !1, animationComplete = !0, particleColors = {
...
function Draw() {
  ...
  function StartConfetti() {
    confettiActive = !0, W_Confetti = window.innerWidth, H_Confetti = window.innerHeight, canvasConfetti.width = W_Confetti, canvasConfetti.height = H_Confetti, function t() {
  ...
  var boxRoot, count = 0, intentos = 3, puedo = !1;
  !function () {
    "use strict";
    boxRoot = {
    _init: function () {
      setTimeout(function () {
        ...
        if (puedo && 0 < intentos) if (jQuery(this).hasClass("abierta")) ;
